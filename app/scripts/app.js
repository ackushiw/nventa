...
var app = angular.module('nventaApp', [
    'ngAnimate',
    'ngCookies',
    'ngResource',
    'ngRoute',
    'ngSanitize',
    'ngTouch',
    'ngMaterial', // for Google Material Design
    'ngAutocomplete', //for Google Places
    'ngStorage', //for local and session storage
    'firebase',
    'firebase.utils',
    'simpleLogin',
    'ui.utils',
    ...
    'ui.map',
    'colorpicker.module',
    'angucomplete' // for autocompleting data into inputs
  ]);
